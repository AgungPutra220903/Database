/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     09/10/2023 09:33:17                          */
/*==============================================================*/
...
alter table DIM_CITY add constraint FK_RELATIONSHIP_11 foreign key (REGION_ID)
      references DIM_REGION (REGION_ID) on delete restrict on update restrict;

alter table DIM_PRODUCT add constraint FK_RELATIONSHIP_12 foreign key (PRODUCT_TYPE_ID)
      references DIM_PRODUCT_TYPE (PRODUCT_TYPE_ID) on delete restrict on update restrict;

alter table DIM_STORE add constraint FK_RELATIONSHIP_10 foreign key (CITY_ID)
      references DIM_CITY (CITY_ID) on delete restrict on update restrict;

alter table DIM_TIME add constraint FK_RELATIONSHIP_6 foreign key (WEEK_ID)
      references DIM_WEEK (WEEK_ID) on delete restrict on update restrict;

alter table DIM_TIME add constraint FK_RELATIONSHIP_7 foreign key (MONTH_ID)
      references DIM_MONTH (MONTH_ID) on delete restrict on update restrict;

alter table DIM_TIME add constraint FK_RELATIONSHIP_8 foreign key (YEAR_ID)
      references DIM_YEAR (YEAR_ID) on delete restrict on update restrict;

alter table DIM_TIME add constraint FK_RELATIONSHIP_9 foreign key (WEEKDAY_ID)
      references DIM_WEEKDAY (WEEKDAY_ID) on delete restrict on update restrict;

alter table FACT_SALES add constraint FK_RELATIONSHIP_1 foreign key (STORE_ID)
...
alter table FACT_SALES add constraint FK_RELATIONSHIP_3 foreign key (EMPLOYEE_ID)
